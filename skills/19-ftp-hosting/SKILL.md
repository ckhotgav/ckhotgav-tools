...
| 免費域名 | 多種子網域可選（含 `.profreehost.com`） | 多種子網域可選（含 `.infinityfreeapp.com`） |
| FTP | ✅ 有控制台 | ✅ 有控制台 |
| MySQL | ✅ 支援 | ✅ 支援 |
| PHP | ✅ 支援 | ✅ 支援 |
| 空間 | 1GB | 5GB |
...
3. 去信箱收驗證信，點擊啟用連結
4. 登入控制台後，建立一個網站帳號
5. 在「選擇網域」步驟可以挑選免費子網域，例如：
   - `你的帳號.profreehost.com`
   - `你的帳號.rf.gd`
   - `你的帳號.c1.biz`
   - 或其他可用選項
...
打開瀏覽器，輸入你在註冊時選的網址（例如 `https://你的帳號.infinityfreeapp.com`），看到網頁就成功了！
