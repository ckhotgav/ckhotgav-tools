...
這個工具箱共有 19 項技能，每一項都可以**獨立選擇要不要安裝**：
...
對 AI 說：
```
請幫我在 Obsidian 中建立一個新筆記，標題是「測試筆記」。
```
如果 Obsidian 中出現了筆記，就成功了！
